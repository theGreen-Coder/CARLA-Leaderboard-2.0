...
from CILv2_multiview.configs.attribute_dict import AttributeDict
import copy
import numpy as np
import os
import yaml

# from CILv2_multiview.logger._logger import create_log
...
_g_conf.DATA_FPS = 10
_g_conf.DATA_COMMAND_CLASS_NUM = 6
