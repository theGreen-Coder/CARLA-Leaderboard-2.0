...
from CILv2_multiview.configs import g_conf
from CILv2_multiview._utils import utils
from CILv2_multiview.network.attention.building_blocks import FC
from CILv2_multiview.network.attention.building_blocks.PositionalEncoding import PositionalEncoding
from CILv2_multiview.network.attention.building_blocks.Transformer.TransformerEncoder import TransformerEncoder
from CILv2_multiview.network.attention.building_blocks.Transformer.TransformerEncoder import TransformerEncoderLayer
...
class CIL_multiview(nn.Module):
    def __init__(self, params, rank: int = 0, average_attn_weights: bool = None):
        ...
        resnet_module = importlib.import_module('CILv2_multiview.network.attention.building_blocks.resnet_FM')
        ...
        if 'type' in self.params['action_output']:
            if self.params['action_output']['type'] == 'decoder_mlp':
                from network.attention.building_blocks.Transformer.TransformerDecoder import TransformerDecoderLayer
                from network.attention.building_blocks.Transformer.TransformerDecoder import TransformerDecoder
