...
from CILv2_multiview.network.loss import Loss
from CILv2_multiview.dataloaders import make_data_loader
from CILv2_multiview._utils.evaluation import evaluation_on_model

from .architectures.CIL_multiview.evaluator import CIL_multiview_Evaluator


class CILv2_multiview_attention_diego(nn.Module):
    def __init__(self, params, rank: int = 0):
        super(CILv2_multiview_attention_diego, self).__init__()
        cil_model = importlib.import_module('CILv2_multiview.network.attention.architectures.CIL_multiview')
        cil_model = getattr(cil_model, "CIL_multiview")
        self.params = params
