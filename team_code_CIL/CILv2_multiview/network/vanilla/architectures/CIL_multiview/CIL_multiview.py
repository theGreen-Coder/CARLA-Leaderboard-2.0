...
from CILv2_multiview.network.vanilla.building_blocks import FC
from CILv2_multiview.network.vanilla.building_blocks.PositionalEncoding import PositionalEncoding
from CILv2_multiview.network.vanilla.building_blocks.Transformer.TransformerEncoder import TransformerEncoder
from CILv2_multiview.network.vanilla.building_blocks.Transformer.TransformerEncoder import TransformerEncoderLayer
...
class CIL_multiview(nn.Module):
    def __init__(self, params):
        ...
        resnet_module = importlib.import_module('CILv2_multiview.network.vanilla.building_blocks.resnet_FM')
