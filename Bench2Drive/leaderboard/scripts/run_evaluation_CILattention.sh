...
######### ATTENTION #########
# This is an almost exact copy of run_evaluation_CIL++.sh. 
# The only difference is the $TEAM_CONFIG and $ALGO
#############################
...
GPU_RANK_LIST=(3)                                   # Example, 8*H100, 1 task per gpu: GPU_RANK_LIST=(0 1 2 3 4 5 6 7), 
TASK_LIST=(0)                                       # TASK_LIST=(0 1 2 3 4 5 6 7)
TASK_NUM=1                                          # Set to number of items in TASK_LIST
...
PLANNER_TYPE=traj
ALGO=CILattention # CHANGE IN THIS LINE 
