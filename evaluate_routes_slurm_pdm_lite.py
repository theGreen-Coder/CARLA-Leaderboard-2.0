...
export SCENARIO_RUNNER_ROOT=carla_garage_path/scenario_runner_autopilot
export LEADERBOARD_ROOT=carla_garage_path/leaderboard_autopilot
...
export TEAM_AGENT={team_code}/autopilot.py
