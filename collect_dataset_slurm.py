...
if __name__ == "__main__":
    ...
    job_name = "collect"
    username = "bjaeger25"
    code_root = r"/mnt/lustre/work/geiger/bjaeger25/garage_2_cleanup"
    carla_root = "/mnt/lustre/work/geiger/bjaeger25/CARLA_0_9_15"
    ...
    route_folder = "/mnt/lustre/work/geiger/bjaeger25/garage_2_cleanup/data"
    ...
    for repetition in range(repetition_start, repetitions):
        for route in routes:
            ...
            job_file = make_jobsub_file(data_save_directory, job_name, routefile_number, partition, repetition, "0-04:00")
